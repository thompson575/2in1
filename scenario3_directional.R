#---------------------------------------------------
# 20% DIRECTIONAL PLEIOTROPY SCENARIO 
#
...
quickSimMR <- function(N,
  ...
  list(varG=varG, varX=varX, varY=varY, varGX=varGX, varXY=varXY, varGY=varGY, 
       G=G, X=X, Y=Y, G2=G2, X2=X2, af=af, 
       sigma=sigma, alpha=alpha, beta=beta, zeta=zeta)
}
...
#-------------------------------------------------
# Simulation with directional pleiotropy with same
# coef as the GX coef but independently assigned
#
quickSimData03 <- function(sp) {
...
write_rds(E, "scenario3_results_100000.rds")
